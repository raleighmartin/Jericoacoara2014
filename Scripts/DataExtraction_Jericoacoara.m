...
file_LoggerTimes = 'LoggerTimes_Jericoacoara.xlsx'; %file with logger times
file_InstrumentVariables = 'InstrumentVariables_Jericoacoara.xlsx'; %file with types of instruments and variables
file_InstrumentMetadata = 'InstrumentMetadata_Jericoacoara.xlsx'; %file with logger tables
file_WeightBSNE = 'WeightBSNE_Jericoacoara.xlsx'; %file with BSNE weights and times
file_GrainSizeMetadata = 'GrainSizeMetadata_Jericoacoara.xlsx'; %file with grain size metadata information
Metadata_Path = strcat(folder_DataOutput,'Metadata_Jericoacoara'); %get path to saving meta data
RawData_Path = strcat(folder_DataOutput,'RawData_Jericoacoara'); %get path to saving raw data
InterpolatedData_Path = strcat(folder_DataOutput,'InterpolatedData_Jericoacoara'); %get path to saving interpolated data
GrainSize_Path = strcat(folder_DataOutput,'GrainSize_Jericoacoara'); % get path to saving grain size data
