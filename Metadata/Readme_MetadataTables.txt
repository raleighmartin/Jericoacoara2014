...
7. "Calibration": Equals 0 when no external calibration is required (but may perform internal calibration, as with Wenglors).  Equals 1 when calibration is required.
...
16. “InstrumentID”: Unique identifier for instrument. This is preferably the serial number for the instrument, if available, but if not is some other traceable unique identifier.
